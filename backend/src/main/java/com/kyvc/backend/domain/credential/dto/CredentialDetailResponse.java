 ...
 * @param walletSavedYn Wallet 저장 여부 Y/N
 ...
 */
@Schema(description = "Credential 상세 응답")
public record CredentialDetailResponse(
        ...
        @Schema(description = "Wallet 저장 여부 Y/N", example = "Y")
        String walletSavedYn, // Wallet 저장 여부 Y/N
