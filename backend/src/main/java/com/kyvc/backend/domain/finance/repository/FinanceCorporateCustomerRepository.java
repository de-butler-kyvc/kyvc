...
/**
 * 금융사 법인 고객 연결 Repository
 */
public interface FinanceCorporateCustomerRepository {

    /**
     * 금융사 법인 고객 연결 저장
     *
     * @param customer 저장 대상 연결
     * @return 저장된 연결
     */
    FinanceCorporateCustomer save(
     ...
     * @return 존재 여부
     */
    boolean existsByFinanceInstitutionAndCustomerNo(
     ...
     * @return 최신 연결 조회 결과
     */
    Optional<FinanceCorporateCustomer> findLatestByLinkedByUserId(
     ...
     * @return 활성 연결 조회 결과
     */
    Optional<FinanceCorporateCustomer> findActiveByCorporateCustomerAndStaff(
