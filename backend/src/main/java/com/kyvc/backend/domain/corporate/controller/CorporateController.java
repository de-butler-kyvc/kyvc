...
public class CorporateController {
    ...
    @Operation(
            ...
            description = "로그인 사용자의 법인 기본정보를 최초 등록합니다. 입력값은 법인명, 사업자등록번호, 대표자명과 선택 기본정보입니다."
    )
    @ApiResponse(
            responseCode = "201",
    ...
    @Operation(
            summary = "법인 기본정보 수정",
            description = "로그인 사용자가 소유한 법인의 기본정보를 수정합니다. 입력값은 법인 ID, 법인명, 사업자등록번호, 대표자명과 선택 기본정보입니다."
    )
    @ApiResponse(
            responseCode = "200",
