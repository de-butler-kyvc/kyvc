...
@Tag(name = "KYC 문서", description = "KYC 문서 업로드와 조회 API")
public class KycDocumentController {
    ...
    @Operation(
            summary = "KYC 서류 업로드",
            description = "KYC 신청 건에 서류 파일을 업로드합니다. 입력값은 KYC 신청 ID, 문서 유형 코드, 업로드 파일입니다."
    )
    @ApiResponse(
            responseCode = "200",
            description = "문서 ID, KYC 신청 ID, 문서 유형, 파일명, 저장 경로, MIME 타입, 크기, 해시, 업로드 상태 반환",
     ...
     */
    @Operation(
            summary = "업로드 서류 목록 조회",
            description = "KYC 신청 건에 업로드된 서류 목록을 조회합니다. 입력값은 KYC 신청 ID입니다."
    )
    @ApiResponse(
            responseCode = "200",
     ...
     */
    @Operation(
            summary = "업로드 서류 상세 조회",
            description = "KYC 신청 건에 업로드된 특정 서류의 상세 정보를 조회합니다. 입력값은 KYC 신청 ID와 문서 ID입니다."
    )
    @ApiResponse(
            responseCode = "200",
            description = "문서 ID, KYC 신청 ID, 문서 유형, 파일명, 저장 경로, MIME 타입, 크기, 해시, 업로드 상태 반환",
