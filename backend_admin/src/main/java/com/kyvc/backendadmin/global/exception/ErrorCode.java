...
public enum ErrorCode {
    ...
    DOCUMENT_DELETE_REQUEST_ALREADY_PROCESSED(HttpStatus.BAD_REQUEST, "DOCUMENT_DELETE_REQUEST_ALREADY_PROCESSED", "이미 처리된 문서 삭제 요청입니다."),
    INVALID_DOCUMENT_DELETE_REQUEST_STATUS(HttpStatus.BAD_REQUEST, "INVALID_DOCUMENT_DELETE_REQUEST_STATUS", "문서 삭제 요청 상태가 올바르지 않습니다."),
