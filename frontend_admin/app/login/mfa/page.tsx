            ...
            <div className="flex gap-2 justify-center">
              {digits.map((d, i) => (
                <input
                  ...
                  className={`w-11 h-12 border rounded-lg text-center text-lg font-semibold focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 ${d ? "border-blue-400 bg-blue-50" : "border-slate-200"}`}
                />
              ))}
            </div>
          </div>
